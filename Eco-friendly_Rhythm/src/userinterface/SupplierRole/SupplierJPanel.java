...
public class SupplierJPanel extends javax.swing.JPanel {
    ...
    public SupplierJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem business) {
        ...
        if (supplier.getProfilePicture() != null) {
            try {
                img = ImageIO.read(supplier.getProfilePicture());
    ...
    private void btnProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileActionPerformed
        ...
        if (chosenFile == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                supplier.setProfilePicture(file);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        supplier.setGender((String) CbGender.getSelectedItem());
        supplier.setContactNumber(txtContact.getText());
        supplier.setZip(txtZipcode.getText());
