...
public class CareTakerJPanel extends javax.swing.JPanel {
    ...
    public CareTakerJPanel(JPanel userProcessContainer, UserAccount userAcount, Enterprise enterprise, EcoSystem business) {
        ...
        if (user.getProfilePicture() != null) {
            try {
                img = ImageIO.read(user.getProfilePicture());
        ...
        username6.setText("Welcome " + user.getUserName() + "!");
        populateCombo();
    ...
    private void btnRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestActionPerformed
        ...
        if (user.isCompleteProfile() == false) {
            ...
            int totalBill = 0;
            try {
                if (cbRequest.getSelectedItem().toString().equals("Fertilizers") && txtFertilizer.getText() != null) {
                    totalBill = fertilizers * Integer.parseInt(txtFertilizer.getText());
                }
                if (cbRequest.getSelectedItem().toString().equals("Pesticides") && txtPesticides.getText() != null) {
                    totalBill = pesticides * Integer.parseInt(txtPesticides.getText());
                }
                if (cbRequest.getSelectedItem().toString().equals("Soil") && txtSoil.getText() != null) {
                    totalBill = soil * Integer.parseInt(txtSoil.getText());
                }
                if (cbRequest.getSelectedItem().toString().equals("Equipments") && txtPrice.getText() != null) {
                    totalBill = Integer.parseInt(txtPrice.getText());
                }
                if (cbRequest.getSelectedItem().toString().equals("Tree") && txtTrees.getText() != null) {
                    totalBill = tree * Integer.parseInt(txtTrees.getText());
                }
